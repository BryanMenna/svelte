...
<div
  class="min-h-screen flex items-center justify-center bg-surface-900 p-4"
...
>
  <div class="w-full max-w-sm p-6 rounded-lg bg-surface-800 shadow-lg text-white"
    style="background-color: #212631; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.6);">
    <h2 class="text-xl font-bold text-center mb-6 text-onSurface"
      style=" font-family: 'Segoe UI', sans-serif;">Login</h2>
    ...
    <div class="mb-4">
      ...
      <div class="relative">
        <input
          ...
          bind:value={username}
        />
        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-onSurface/60"
          style="color: #6c6c74;">
          <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
            <path
              d="M10 10a4 4 0 100-8 4 4 0 000 8zm0 2c-4.418 0-8 1.79-8 4v2h16v-2c0-2.21-3.582-4-8-4z" />
          </svg>
        </span>
      </div>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="relative">
        ...
        <span class="absolute left-3 top-1/2 -translate-y-1/2" style="color: #6c6c74;">
          <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
            <path
              d="M5 8V6a5 5 0 1110 0v2a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2zm2-2v2h6V6a3 3 0 00-6 0z" />
          </svg>
        </span>
